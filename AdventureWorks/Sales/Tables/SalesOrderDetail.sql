CREATE TABLE [Sales].[SalesOrderDetail] (
    ...
    [__OStartTime]          DATETIME2 (7) GENERATED ALWAYS AS ROW START DEFAULT (sysutcdatetime()) NOT NULL,
    [__OEndTime]            DATETIME2 (7) GENERATED ALWAYS AS ROW END   DEFAULT (CONVERT([datetime2],'9999-12-31 23:59:59.9999999')) NOT NULL,
    [test_column]           NCHAR (10)                                  NULL,
    CONSTRAINT [PK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID] PRIMARY KEY NONCLUSTERED ([SalesOrderID] ASC, [SalesOrderDetailID] ASC),
    ...
    PERIOD FOR SYSTEM_TIME ([__OStartTime], [__OEndTime])
)
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE=[History].[Sales-SalesOrderDetail-History], DATA_CONSISTENCY_CHECK=ON));
